...
echo "  2. Pick this ONE file:  $(dirname "$HERE")/auto_sync_pipeline.lua"
...
echo "If ReaImGui cannot be installed here, reaper/Import_Dub_Results.lua still"
echo "imports a finished run on its own — that is the only file in reaper/ you"
echo "would ever load directly."
